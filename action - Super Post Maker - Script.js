...
if (!result) {
    ...
    prompt.addSelect(
        "postType",
        "Post type",
        ["blog", "quote", "rss", "til", "ways", "mixtapes", "social", "gift", "mailbox", "film" ],
        ["blog"],
        false,
    );
    ...
    if (prompt.buttonPressed === "Ok") {
        ...
        if (postType === "quote" && linkVal === "" && citedVal === "") {
            ...
            if (postType === "mixtapes") {
                mixtapeTitle = extractMixtapeTitle(draft.content) || titleVal;
            }
            ...
            if (postType !== "mixtapes") {
                ...
                newDraft += "syndicate: " + syndicateVal + "\n";
                ...
                if (typeMap[postType]) {
                    newDraft += "type: " + typeMap[postType] + "\n";
                }
